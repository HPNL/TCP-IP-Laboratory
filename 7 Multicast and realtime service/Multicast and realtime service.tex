...
\part{IGMP Exercises}
    ...
    \begin{table}[H]
        \caption{Hosts IP addresses for Fig. 7.13 (Table~7.2.)}
        \label{tbl:7.2}
        \centering
        \begin{tabular}{ *3c }
            \hline \hline
    ...
    \begin{table}[H]
        \caption{Router IP addresses for Fig. 7.13 (Table~7.3.)}
        \label{tbl:7.3}
        \centering
        \begin{tabular}{ *3c }
            \hline \hline
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw[thick] (-4.5,0) -- (router);
        \end{tikzpicture}
        \caption{The network topology for the exercises in Section 7.5. (Figure~7.13.)}
        \label{fig:7.13}
    \end{figure}
...
\part{Multicast Routing Exercises}
    ...
    \begin{figure}[H]
        ...
        \end{tikzpicture}
        \caption{The network topology for Multicast exercises (Figure~7.14)}
        \label{fig:7.14}
    \end{figure}
