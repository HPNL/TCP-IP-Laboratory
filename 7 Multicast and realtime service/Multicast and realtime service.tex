...
\part{Multicast Routing Exercises}\label{sec:multicast-routing}
    For the rest of the exercises in this chapter, the network topology is given in \hyperref[fig:7.14]{Figure~7.14}. The exercises will be jointly performed by all the students. The IP addresses of the hosts and router interfaces are given in \hyperref[fig:7.14]{Figure~7.14}.
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}
