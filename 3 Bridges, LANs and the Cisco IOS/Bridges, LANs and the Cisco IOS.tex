...
\label{sec:spanning-tree}
    ...
    You need to change the IP addresses of the bridge interfaces, as well as that of your machines.
...
\section{STP over Topology Dynamics}
    ...
    Once you can successfully reach other hosts, get to the bridges to run \lstinline[language=cisco]{show bridge} to collect the port states.
