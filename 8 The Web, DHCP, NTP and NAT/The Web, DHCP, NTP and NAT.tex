...
\section{NTP Sync}
    ...
    Use \lstinline[emph={your-host, remote-host, h0},morekeywords={[3],host,and}]{tcpdump -ex -n -nn host your-host and h0} or \lstinline{wireshark} to capture packets between your host and \textit{h0}.
...
\section{** NTP Server}
    ...
    Execute \lstinline[emph={your-host, remote-host},morekeywords={[3]host,and}]{tcpdump -exn -nn host your-host and 128.238.66.100} or \lstinline{wireshark} to capture the NTP messages between \textit{your-host} and \textit{h0}.
