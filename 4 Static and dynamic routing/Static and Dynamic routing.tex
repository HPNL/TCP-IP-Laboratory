...
\part{A Simple Router Experiment}
    ...
    \begin{figure}[H]
        ...
        \end{tikzpicture}
        \caption{Simple router experiment (Figure~4.10)}
    \end{figure}
...
Router(config)# no router rip
    ...
    \begin{figure}[H]
        ...
        \end{tikzpicture}
        \caption{Network Configuration for RIP exercises (Figure~4.11)}
    \end{figure}
...
\section{**Router Discovery}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw (h7) -- (s1);
        \end{tikzpicture}
        \caption{Network configuration of the ICMP router discovery experiment (Figure~4.12)}        
    \end{figure}
...
Router(config-router)# network address wildcard-mask area area-id
    ...
    \item \lstinline{area-id} is the number of the area that the interfaces belong to (see Figure 4.7).
...
\end{itemize}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw[thick] (-3.5,-2) -- +(7,0) node[pos=0.5,above] {\scriptsize 128.238.63.0 subnet};
        \end{tikzpicture}
        \caption{Network Configuration for OSPF exercises, static routing experiments and \lstinline{traceroute (Figure~4.13)} experiment}
    \end{figure}
