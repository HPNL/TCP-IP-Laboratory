...
In this lab, you need two workstations, a bridge, and two hubs, which are required to be connected as shown in \hyperref[tab:4.2]{Table~4.2} and \hyperref[tab:4.3]{Table~4.3}.
    \begin{table}[H]
...
\section{Simple Routing}
    ...
    In order to be connected, you need to add a routing entry for the other subnet in the routing table of all workstations (see section 4.3.1).

    You can use one of the following commands to add routing in workstations.
...
\section{ICMP redirect}
    ...
    Create a default routing entry using one of the routers directly connected to your workstation (add route with default gateway). Also may you need to delete previously added route.
