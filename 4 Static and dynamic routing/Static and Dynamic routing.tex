...
\section{Router Discovery}
    ...
    Telnet to the routers, change the IP address of the ethernet1 interfaces as shown in Fig. 4.12. Enable ICMP router discovery on these two interfaces by the following
    
    \textit{Interface Configuration command:}
    \begin{lstlisting}[language={cisco}]
...
Router(config-router)# network address wildcard-mask area area-id
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw[thick] (-3.5,-2) -- +(7,0) node[pos=0.5,above] {\scriptsize 128.238.63.0 subnet};
        \end{tikzpicture}
        \caption{\textit{Figure 4.11} Network Configuration for OSPF exercises, static routing experiments and \lstinline{traceroute} experiment}
    \end{figure}
