...
\begin{frame}
    ...
    \end{enumerate}
    \begin{alertblock}{Important}
        You need to submit your report on time. even if you couldn't finish your lab on time.
    \end{alertblock}
...
\begin{frame}
    ...
    LATE ARRIVAL:
    {
        ...
        \begin{block}{Below 15 minutes} Don’t worry (but you may miss quiz) \end{block}
    }
    {
        \setbeamercolor{block body}{fg=black, bg=orange!10!white}
        \setbeamercolor{block title}{fg=white, bg=orange!50!black}
        \begin{block}{Between 15 and 30 minutes} Get \alert{-0.5} penalty score for your session grade \end{block}
    }
    \begin{alertblock}{More than 30 minutes} Don’t enter the class, Get \alert{0} for session grade (absence grade) \end{alertblock}
...
\begin{frame}
    ...
    \begin{itemize}
        \item 10 lab with score of \alert{2} for each lab (total score sum is \alert{20})
...
\begin{frame}
    \frametitle{Consider this rule in your answers}
