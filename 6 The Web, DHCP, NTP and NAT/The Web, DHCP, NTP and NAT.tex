...
\begin{document}
    ...
    \begin{enumerate}
        ...
        Justify your answer using the httpd.conf file. \\
        \item What is the purpose of initiating multiple httpd processes? \\
    \end{enumerate}

    %\pagebreak
    \section*{HTTP exercises 2}
    ...
    %\pagebreak
    \section*{DHCP exercises 1 \footnote{For the exercises in this section, we use the same network setting as the one used in the previous exercises.}}
